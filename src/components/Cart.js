...
const Cart = () => {
  ...
  const stripePromise = loadStripe('pk_test_51NNL2GGG7XmBp2MHxecQFYyVKy0bZ5z3MsKrNvXpdAU9dSzO0krudv1TiXnKOekfAxT32n6tQMLVYLz6jQ1pzQCK00EjZ3JsQY');
  ...
  return (
     <div className='x-full h-full px-4 text-white'>
      ...
      {cart.length >= 1 ? (
       <div className='flex justify-between gap-x-4'>
        ...
        -z-10 flex-col text-white/30'>
            <div className='text-2x1'>Votre panier est vide</div>
            <div className='text-6x1'><IoCartOutline /></div>
        </div>
      )}
     </div>
  </div>
